...
def create_mesh_test(fsdp_size, tp_size, sp_size):
    ...
    fsdp_mesh, tp_mesh, _, sp_mesh, gather_mesh, train_mesh = create_mesh(fsdp_size, tp_size, 1, sp_size)
...
def create_duplicate_mesh(fsdp_size, tp_size, sp_size):
    fsdp_mesh1, tp_mesh1, _, sp_mesh1, gather_mesh1, train_mesh = create_mesh(fsdp_size, tp_size, 1, sp_size)
    fsdp_mesh2, tp_mesh2, _, sp_mesh2, gather_mesh2, train_mesh = create_mesh(fsdp_size, tp_size, 1, sp_size)
