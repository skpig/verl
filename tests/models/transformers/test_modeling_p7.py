...
from seed_models.models.p7.modeling_p7 import P7ForCausalLM
from test_utils import ref_loss_fn, compare_tensors, prepare_data


def build_model():
    # hdfs path available at tasks_scripts/ci/run_p7_2b5_math_v1.sh
    # hdfs://haruna/home/byte_data_seed/ssd_lq/public/seed_models/Seed-2B5-P7_32k_sft29_32gpu/config.json
    config = AutoConfig.from_pretrained('Seed-2B5-P7_32k_sft29_32gpu/config.json',
                                        attn_implementation='flash_attention_2')
    config.num_hidden_layers = 8
    # sliding window length should be the same as num_hidden_layers
...
def test_logits_cross_entropy_fusion():
    ...
    # Mismatched elements: 2431599 / 317718528 (0.8%)
