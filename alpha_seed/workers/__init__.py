...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self):
        ...
        elif self.config.rollout.name == 'xperf_gpt':
            import xperf_gpt
            xperf_gpt.load_xperf_gpt()
            from verl.trainer.ppo.rollout.xperf_rollout.xperf_gpt_rollout import XPerfGPTRollout
            from verl.trainer.ppo.hybrid_engine import FSDPXPerfGPTShardingManager
