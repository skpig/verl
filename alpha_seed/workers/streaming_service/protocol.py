...
class ChatCompletionMessageRollout(ChatCompletionMessage):
    ...
    response_probs_gt_threshold_num: Optional[List[int]] = None
    """The number of tokens that are greater than the threshold."""
    response_probs_lt_threshold_sum: Optional[List[int]] = None
    """The number of tokens that are less than the threshold."""
