...
def deepscaler_reward_fn(solution_str: str, ground_truth: Union[str, List[str]], **kwargs):
...
if __name__ == "__main__":
    ...
    d = {
        'solution_str': "<think> I am omniscient. </think> The answer is \\boxed{24 + 14*x + (-13)*x^2 - 2*x^3 + x^4}.",
        'ground_truth': ["10", "$x^{4}-2 x^{3}-13 x^{2}+14 x+24$"]
    }
    assert deepscaler_reward_fn(**d) == 1
    ...
    d = {
        'solution_str': "<think> I am omniscient. The answer is \\boxed{24 + 14*x + (-13)*x^2 - 2*x^3 + x^4}.",
        'ground_truth': ["10", "$x^{4}-2 x^{3}-13 x^{2}+14 x+24$"]
    }
    assert deepscaler_reward_fn(**d) == -1
