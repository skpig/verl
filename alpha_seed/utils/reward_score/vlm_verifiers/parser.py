...
def extract_answer(pred_str, is_choice=False, use_last_number=True, use_box_only=False):
    ...
    if use_box_only and not extract_from_box:
        pred = ""
...
\\boxed{\\frac{386}{64}}
"""
    print(extract_answer(text, is_choice=False, use_last_number=False))
