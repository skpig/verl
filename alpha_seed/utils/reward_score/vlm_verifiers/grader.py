...
def _test_math_equal():
    assert math_equal("0.0833333333333333", "\\frac{1}{12}") == True
    assert math_equal("(1,4.5)", "(1,\\frac{9}{2})") == True
    assert math_equal("\\frac{x}{7}+\\frac{2}{7}", "\\frac{x+2}{7}", timeout=True) == True
    assert math_equal("\\sec^2(y)", "\\tan^2(y)+1", timeout=True) == True
    assert math_equal("\\begin{pmatrix}-\\frac{7}{4}&-2\\\\4&\\frac{1}{4}\\end{pmatrix}",
    ...
    assert math_equal(pred, gt) == True
    ...
    pred = '\\frac{100}{3}'
    gt = '33.3'
    assert math_equal(pred, gt) == False
    ...
    gt = "x+2n+1"
    pred = "x+1"
    assert math_equal(pred, gt, timeout=True) == False
