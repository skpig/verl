...
class BoxStrVerifier(Verifier, reward_style="verifier_boxed_str"):
...
def compute_score(solution_str, ground_truth, **kwargs) -> float:
    ...
    score, tag = submit_verifier(solution_str, ground_truth, tokenizer.eos_token, tokenizer.bos_token, think_template)
    return score
