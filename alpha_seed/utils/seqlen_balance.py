"""
The following code is copied from seed_rl
"""
...
def rearrange_micro_batches(batch: TensorDict, max_token_len):
    ...
    torch.distributed.all_reduce(num_micro_batches, op=torch.distributed.ReduceOp.MAX)
...
if __name__ == '__main__':
    seqlen_list = [8192, 37, 58, 367, 887, 23, 456, 1035, 3986, 567, 873, 348, 90, 1247, 8054, 1240]
    output = get_seqlen_balanced_partitions(seqlen_list=seqlen_list, k_partitions=4, equal_size=False)
    ...
    micro_batches, num_micro_batches = rearrange_micro_batches(dataproto.batch, max_token_len=300)
