...
class RayResourcePool(ResourcePool):
    ...
    def get_placement_groups(self, strategy="STRICT_PACK", name=None, device_name="cuda"):
        ...
        pg_scheme = [[bundle.copy() for _ in range(process_count)] for process_count in self._store] # 每个node上创建一个placement group，每个placement group包含n_gpus_per_node bundles, each bundle has max_colocate_count CPUs and 1 GPU if use_gpu is True.
