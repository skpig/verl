...
def convert_data(path):
    ...
    df_out['data_source'] = ["AIME" for row in df['problem']]
    ...
    df_out['extra_info'] = [{'index': row['id']} for row in df['meta']]
...
if __name__ == "__main__":
    path = "/opt/tiger/alphaseed_data/data/math_data/evaluation_data/AIME_evals.jsonl"
    df_out = convert_data(path)
    df_out.to_parquet("hdfs://harunava/home/byte_data_seed_azure/seed_research/shengdinghu/rl/datasets/math_data/evaluation_data/AIME_evals.parquet")
