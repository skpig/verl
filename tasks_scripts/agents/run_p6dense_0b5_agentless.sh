...
TRAIN_FILE=hdfs://haruna/home/byte_data_seed/hdd_wlcb/user/jiangyun.jy/datasets/rl_data/swe_gym_agentless_full_valid_filterPass_1024.parquet
TEST_FILE=hdfs://haruna/home/byte_data_seed/lf_lq/user/jiangyun.jy/datasets/rl_data/alphaseed_swe_bench_verified_agentless_500.parquet
default_hdfs_dir=hdfs://haruna/home/byte_data_seed/lf_lq/user/sunhe/test/p6dense_0b5_agentless
...
rollout_mode='server'
handler='agent/agentbench/agentless'

python3 tasks/main_ppo.py \
    rollout_server.handler=${handler} \
