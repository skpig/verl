...
# TRAIN_FILE=hdfs://haruna/home/byte_data_seed/ssd_hldy/user/yueyu/alphaseed_workspace/data/Gaokao/mixrl/F0624_gym405_sbt353_smith500_rebench1952_all3210.fix_v2.parquet
# TEST_FILE=hdfs://haruna/home/byte_data_seed/ssd_hldy/user/yueyu/alphaseed_workspace/data/Gaokao/mixrl/alphaseed_swe_bench_verified_agentless_500.fix_v2.parquet

TRAIN_FILE=hdfs://haruna/home/byte_data_seed/ssd_hldy/user/yueyu/alphaseed_workspace/data/Gaokao/mixrl/generalize_reasoning_search_ci_train.parquet
TEST_FILE=hdfs://haruna/home/byte_data_seed/ssd_hldy/user/yueyu/alphaseed_workspace/data/Gaokao/mixrl/generalize_reasoning_search_ci_eval.sample.newv2.parquet

default_hdfs_dir=hdfs://haruna/home/byte_data_seed/lf_lq/user/qiying.01/projects/alphaseed/experiments/${EXP}
# 训练长度
...
# tracking实验名
project_name='alpha-seed-agent-debug-yy'
# 工程参数
...
python3 tasks/main_ppo.py \
    ...
    trainer.use_remote_swe_sandbox=True \
    ...
    rollout_server.handler=agent/tool/special_calculator \
    actor_rollout_ref.rollout.rollout_pool.clear_rollout_pool=True \
    actor_rollout_ref.rollout.rollout_pool.upsample_mode=mini_batch \
    actor_rollout_ref.actor.max_ppo_mini_batch=16
    # rollout_server.external_lib="agents_extension.handlers" \
    # +rollout_server.handler_kwargs.return_all_rounds=True \
    # +rollout_server.handler_kwargs.plugin_config.enable=True \
    # +rollout_server.handler_kwargs.plugin_config.plugin_external_lib="agents_extension.plugins" \
    # +rollout_server.handler_kwargs.plugin_config.env_external_lib="agents_extension.envs" \
    # +rollout_server.handler_kwargs.plugin_config.names=['function_call','file_system_function_call'] \
    # +rollout_server.handler_kwargs.plugin_config.args.function_call.result_begin_tag="" \
    # +rollout_server.handler_kwargs.plugin_config.args.function_call.result_end_tag="" \
    # +rollout_server.handler_kwargs.plugin_config.args.function_call.exclude_begin_tag="'<think>'" \
    # +rollout_server.handler_kwargs.plugin_config.args.function_call.exclude_end_tag="'</think>'" \
    # +rollout_server.handler_kwargs.plugin_config.args.function_call.format=json
