...
TRAIN_FILE=hdfs://haruna/home/byte_data_seed/lf_lq/user/zhangchi.usc1992/data/math_expression_tool/train.parquet
# TRAIN_FILE=hdfs://haruna/home/byte_data_seed/lf_lq/user/qiying.01/projects/alphaagent/datasets/0703_mathci_train_intonly_ci_dataset.parquet
...
# rollout_server.handler=agent/advanced_ci \
python3 tasks/main_ppo.py \
    ...
    # streaming_rollout.elastic.elastic_pool_name=worker \
