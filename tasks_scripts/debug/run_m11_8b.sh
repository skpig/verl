...
# ckpt和路径
SFT_MODEL_PATH=hdfs://haruna/home/byte_data_seed/lf_lq/user/zhiqi.0/models/m11_8b_debug
...
default_hdfs_dir=hdfs://haruna/home/byte_data_seed/lf_lq/user/zhangchi.usc1992/test/m11_8b_grpo
...
reward_sp_size=1
fsdp_size=64
xperf_tp_size=8  # infer tp
oe_size=64  # oe tp size
tp_size=4  # this is actually ep in training
...
python3 tasks/main_ppo.py \
    ...
    +data.chat_template=raw \
    actor_rollout_ref.actor.use_dynamic_bsz=${use_dynamic_bsz} \
    actor_rollout_ref.actor.strategy=${strategy} \
    actor_rollout_ref.ref.strategy=${strategy} \
    critic.strategy=${strategy} \
    actor_rollout_ref.actor.oe_size=${oe_size} \
    actor_rollout_ref.ref.oe_size=${oe_size} \
    critic.oe_size=${oe_size} \
