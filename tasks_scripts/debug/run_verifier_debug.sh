...
TRAIN_FILE=hdfs://haruna/home/byte_data_seed/ssd_hldy/user/chenjiaze/alphaseed_data/rl_training/0113_math_verifier.parquet
TEST_FILE=hdfs://haruna/home/byte_data_seed/lf_lq/user/yueyu/data/rlhf/math_code_gpqa_eval_1214.parquet
default_hdfs_dir=hdfs://haruna/home/byte_data_seed/lf_lq/user/zhangchi.usc1992/debug
# 训练长度
...
python3 tasks/main_ppo.py \
    ...
    trainer.code_sandbox_psm='seed.alpha.sandbox_happy_new_year.service.hl' \
