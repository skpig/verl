...
TRAIN_FILE=hdfs://haruna/home/byte_data_seed/lf_lq/user/yueyu/data/rlhf/math_code_1213.parquet
...
python3 tasks/main_ppo.py \
    trainer.code_sandbox_psm='seed.alphaseed.sandbox.teoy_dev_1210_new.service.hl' \
