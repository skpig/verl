...
# ckpt和路径
SFT_MODEL_PATH=hdfs://haruna/home/byte_data_seed/hl_lf/user/xiangyongan/model/m11_vlm_8b_dev
...
# tracking实验名
project_name='alpha_seed_m11_vlm'
experiment_name="m11_8b_grpo_$(date +%F)"
