...
use_remote_rm=True
use_rm_reverse=True
rm_psm="data.aml.arnold_inference_60311938"
rm_idc="'lq,lf,hl,yg,gl,wlby'"
rm_cluster="default"
rm_model_name="vlm/VLM_M8-2.5B-phase1_text_182kCT2_123kRationale_158kMath_phase2_hist26k_online18k_complex1k_ref_replay_qrm"
...
python3 tasks/main_ppo.py \
    ...
    reward_model.qrm.use_rm_reverse=${use_rm_reverse} \
    reward_model.grm.score_merger=v1 \
    reward_model.qrm.max_prompt_length=${max_grm_prompt_length} \
