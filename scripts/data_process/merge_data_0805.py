...
# agent
## search && textbrowser
hdfs://haruna/home/byte_data_seed/ssd_hldy/user/caiwenjie.cwj/alphaseed_workspace/data/deep_search/rl_data/xinyao_0620_engcn_queries_v3/processed_text.parquet, agent/tool/search_and_text_browser, 1
hdfs://haruna/home/byte_data_seed/ssd_hldy/user/caiwenjie.cwj/alphaseed_workspace/data/deep_search/rl_data/webcrawl_rl_data/processed_text.parquet, agent/tool/search_and_text_browser, 1
hdfs://haruna/home/byte_data_seed/lf_lq/user/qiying.01/projects/agent/dataset/rl/0722_data_dr_alex_68x64.parquet, agent/tool/search_and_text_browser, 1
hdfs://haruna/home/byte_data_seed/lf_lq/user/qiying.01/projects/agent/dataset/rl/0722_data_dr_zehui_1816x8.parquet, agent/tool/search_and_text_browser, 1
hdfs://harunawl/home/byte_data_seed_wl/alphaseed/user/zuoxiaochen.221/data/all_data_for_search.asformat.76132.parquet, agent/tool/search_and_text_browser, 1
## ci
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0711_train_cidr_MATH_34465_new_framework_0730.parquet, agent/ci, 1
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0711_train_cidr_MATH_0515_6067_new_framework_0730.parquet, agent/ci, 1
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0714_train_ci_euler_808x32_new_framework_0730.parquet, agent/ci, 1
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0707_train_ci_science_4998x8_new_framework_0730.parquet, agent/ci, 1
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0711_train_cidr_PHY_0515_3988_new_framework_0730.parquet, agent/ci, 1
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0711_train_cidr_STEM_1830_new_framework_0730.parquet, agent/ci, 1
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0711_train_cidr_CHE_0515_1027_new_framework_0730.parquet, agent/ci, 1
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0711_train_cidr_PUZZLE_14768_new_framework_0730.parquet, agent/ci, 1
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0707_train_ci_dsut_384x32_new_framework_0730.parquet, agent/ci, 1
"""
save_path = "search_ci_generalreasoning_0801_2.parquet"
is_eval = False
...
# base reasoning
## math && stem
hdfs://haruna/home/byte_data_seed/ssd_hldy/user/alphaseed/data/rl_dataset/aime2024_rule_verifier.parquet, agent/base_reasoning_handler, 8
hdfs://haruna/home/byte_data_seed/ssd_hldy/user/alphaseed/data/rl_dataset/aime2025_rule_verifier.parquet, agent/base_reasoning_handler, 8
hdfs://haruna/home/byte_data_seed/ssd_hldy/user/alphaseed/data/rl_dataset/beyondaime_rule_verifier_v3.parquet, agent/base_reasoning_handler, 8
...
# agent
## ci
hdfs://harunawl/home/byte_data_seed_wl/search_agent/user/chen.dun/data/0714_val_ci_euler_100_new_framework_0730.parquet, agent/ci, 1
hdfs://haruna/home/byte_data_seed/hdd_hldy/user/wangchengyi.01/data/o1_proj/rl/aime_beyondaime_citest_x10_new_framework_0730.parquet, agent/ci, 1
hdfs://haruna/home/byte_data_seed/hdd_hldy/user/wangchengyi.01/data/o1_proj/rl/hle_432_eval_new_new_framework_0730.parquet, agent/ci, 1
## search && textbrowser
...
"""
save_path = "search_ci_generalreasoning_eval_0801.parquet"
is_eval = True
...
for path in paths:
    ...
    for key in cur_necessary_keys:
        if key == "ability" and key not in cur_df.keys():
            if agent_handler == "agent/tool/search_and_text_browser":
                cur_df.loc[:, "ability"] = np.array(["Search" for _ in range(len(cur_df))])
            elif agent_handler == "agent/ci":
                cur_df.loc[:, "ability"] = np.array(["CI" for _ in range(len(cur_df))])
            else:
                assert False
...
df['initial_files'] = json.dumps({'initial_files': {}})


def delete_system(prompt):
    res = []
    for item in prompt:
        if item['role'] == 'system':
            continue
...
df['prompt'] = df['prompt'].apply(delete_system)
...
os.system(
    f"hadoop fs -put {save_path} hdfs://haruna/home/byte_data_seed/lf_lq/user/qiying.01/projects/agent/dataset/rl")
