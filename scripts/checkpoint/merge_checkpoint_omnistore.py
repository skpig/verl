...
if __name__ == '__main__':
    ...
    with tempfile.TemporaryDirectory() as local_tmp_dir:
        ...
        print('Step4: force convert state dict to bf16')
        time_begin = time.time()
        ...
        print('Step5: load state_dict to huggingface model')
        time_begin = time.time()
        ...
        print(f'Step6: save merged huggingface model to local {hf_path}')
        time_begin = time.time()
        ...
        print(f'Step7: async save merged huggingface model and configs from {hf_path} to remote {args.save_path}')
        ...
        print(f'Step8: convert model to xperf format and async upload to {args.save_path}')
        ...
        print(f'Step9: wait async upload hf and xperf merged ckpt')
        time_begin = time.time()
