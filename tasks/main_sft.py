...
def main_task(config):
    ...
    pprint((config.trainer.num_gpus_per_node, config.trainer.num_nodes))

    resource_pool = RayResourcePool([config.trainer.num_gpus_per_node] * config.trainer.num_nodes, use_gpu=True)
